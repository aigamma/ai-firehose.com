...
summary: A family of reinforcement learning methods that directly optimize a parameterized policy by following the gradient of expected reward, adjusting the policy's parameters to make high-reward actions more likely.
---
