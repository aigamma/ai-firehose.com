...
summary: A family of reinforcement learning methods in which the agent learns or is given a model of the environment's dynamics and rewards, then uses that model to plan or to generate simulated experience, typically improving sample efficiency.
---
