...
summary: The practice of adding supplementary reward signals to guide a reinforcement learning agent toward desired behavior, most safely done with potential-based functions that speed learning without changing which policy is optimal.
---
