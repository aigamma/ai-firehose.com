...
summary: A function that estimates the expected long-run reward an agent will accumulate from a given state, or from a given state-action pair, under a particular policy; it is the core predictive object that most reinforcement learning algorithms learn.
---
