...
The central challenge is preserving what was transferred while absorbing the new task. Adapt too gently and the model never specializes; adapt too aggressively and it overwrites its general knowledge, the failure known as catastrophic forgetting. Much of the design of fine-tuning methods, smaller learning rates, frozen backbones, low-rank adapters, is really about managing this balance so the transferred knowledge survives.
