...
summary: The two distinct phases of autoregressive language model inference: a compute-bound prefill that processes the whole prompt in parallel to fill the key-value cache, followed by a memory-bound decode that generates output one token at a time.
---
