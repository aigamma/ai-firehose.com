...
summary: An inference strategy that generates N candidate responses and selects the best according to a scorer (a reward model, a verifier, or a heuristic), spending parallel compute to lift quality on tasks where judging an answer is easier than producing one.
---
