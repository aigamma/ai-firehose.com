...
summary: A decoding adjustment that lowers the probability of tokens the model has already produced, discouraging the loops and verbatim repetition that language models fall into, especially under low-randomness decoding.
---
