...
summary: The raw, unnormalized scores a model emits for every token in its vocabulary at each step, before a softmax converts them into a probability distribution. Every decoding and sampling control operates on logits.
---
