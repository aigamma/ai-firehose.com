...
summary: The core computation of a graph neural network, in which each node computes its new representation by gathering and aggregating messages from its neighbors, then updating itself, repeated layer by layer.
---
