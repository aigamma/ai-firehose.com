...
summary: A methodological flaw in which information from outside the training set, especially from the test set or the future, slips into training, so a model scores far better in evaluation than it will in reality; the most common reason a model looks great and then fails in deployment.
---
