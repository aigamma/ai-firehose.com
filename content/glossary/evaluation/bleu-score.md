...
summary: An n-gram overlap metric for machine translation that scores a candidate against reference translations by modified n-gram precision, multiplied by a brevity penalty; higher is better, on a 0 to 1 scale. Its defining weakness is that it rewards surface form, not meaning: a correct paraphrase in different words scores poorly, which is exactly the gap semantic and judge-based metrics were built to close.
---
