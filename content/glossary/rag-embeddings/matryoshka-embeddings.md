...
summary: An embedding training method that packs information into a vector in order of importance, so a single high-dimensional embedding can be truncated to a shorter prefix and still work, letting one model serve many embedding sizes and enabling cheap coarse-to-fine retrieval.
---
