...
summary: A retrieval architecture that encodes a query and a document independently into separate vectors and scores their relevance by a simple similarity between those vectors, which makes document embeddings precomputable and indexable, enabling fast search over a large corpus.
---
