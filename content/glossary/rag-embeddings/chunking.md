...
summary: The step in a retrieval pipeline that splits long documents into smaller passages before embedding, so each stored vector represents a focused unit of text that can be retrieved and cited on its own.
---
