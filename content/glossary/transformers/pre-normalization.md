...
summary: A transformer design choice that applies layer normalization to the input of each sublayer rather than to its output, which keeps the residual pathway clean and makes deep models far more stable to train.
---
