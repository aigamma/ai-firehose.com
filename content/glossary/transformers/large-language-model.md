...
summary: A transformer with billions of parameters trained on vast text corpora by next-token prediction, which acquires broad language and reasoning ability that can be steered to many tasks without task-specific training.
---
