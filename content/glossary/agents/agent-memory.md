...
summary: The mechanisms an agent uses to retain and recall information across the steps of a task and across separate sessions, compensating for the fact that the underlying language model is stateless between calls and limited by its context window.
---
