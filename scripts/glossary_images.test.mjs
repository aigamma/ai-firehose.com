...
test("licenseOk accepts redistributable licenses, rejects NC/ND/non-free", () => {
  ...
  assert.ok(licenseOk("AI-generated")); // figures we generate ourselves
  assert.ok(licenseOk("Generated by OpenAI gpt-image-1"));
...
test("licenseUrl maps to canonical deeds", () => {
  ...
  assert.equal(licenseUrl("AI-generated"), ""); // no canonical deed; the row supplies the model's terms
});
