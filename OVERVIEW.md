...
| Thing | Count |
|---|---|
| Authored, durable knowledge-base concepts | 644 |
| Knowledge categories | 33 |
| Total concepts (644 durable plus a live-trending corpus layer) | grows and prunes daily |
